...
BikerWeedFarm = {
    ...
    LoadDefault = function()
        ...
        BikerWeedFarm.Plant1.Set(BikerWeedFarm.Plant1.Stage.full, BikerWeedFarm.Plant1.Light.upgrade)
        BikerWeedFarm.Plant2.Set(BikerWeedFarm.Plant2.Stage.full, BikerWeedFarm.Plant2.Light.upgrade)
        BikerWeedFarm.Plant3.Set(BikerWeedFarm.Plant3.Stage.full, BikerWeedFarm.Plant3.Light.upgrade)
        BikerWeedFarm.Plant4.Set(BikerWeedFarm.Plant4.Stage.full, BikerWeedFarm.Plant4.Light.upgrade)
        BikerWeedFarm.Plant5.Set(BikerWeedFarm.Plant5.Stage.full, BikerWeedFarm.Plant5.Light.upgrade)
        BikerWeedFarm.Plant6.Set(BikerWeedFarm.Plant6.Stage.full, BikerWeedFarm.Plant6.Light.upgrade)
